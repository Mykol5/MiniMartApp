            ...
            <Pressable style={{ 
              ...
              {isActive && (
                <View style={{
                  ...
                  height: 35,
                  borderRadius: 20,
                  backgroundColor: '#60B5FF', // Solid blue underlay
                  top: -10, // Adjust position to center under icon
                }} />
              )}
              ...
              <Image 
                ...
                style={{ 
                  width: 19.5, 
                  height: 21,
                  tintColor: isActive ? 'white' : '#000', // White when active
                  marginBottom: 4,
                  zIndex: 1, // Ensure icon appears above underlay
                }} 
              />
              <Text style={{ 
                fontSize: 12.5, 
